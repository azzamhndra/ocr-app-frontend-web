      ...
      <div className={`dashboard-sidebar ${sidebarOpen ? 'open' : 'closed'}`}>
        <div className="sidebar-header">
          <div className="sidebar-logo">
            ...
            />
            {sidebarOpen && <span className="sidebar-logo-text">Dashboard</span>}
          </div>
        ...
        <nav className="sidebar-nav">
          <Link to="/dashboard" className={`sidebar-link ${isActive('/dashboard') && !isActive('/dashboard/profile') && !isActive('/dashboard/settings') && !isActive('/dashboard/users') && !isActive('/dashboard/monitor') ? 'active' : ''}`}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <Link to="/dashboard/monitor" className={`sidebar-link ${isActive('/dashboard/monitor') ? 'active' : ''}`}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  const [notif, setNotif] = useState([])
    ...
    useEffect(() => {
      ...
      const processItem = (data) => {
        const isProblem = data.power < 45 || data.cn < 20.5 || data.mer < 26 || data.linkMargin < 3
        if (isProblem) {
          setNotif(prev => [...prev, {
            ...
            parameter: [
              ...
              ...(data.linkMargin < 3 ? [`Link Margin (${data.linkMargin})`] : [])
            ],
